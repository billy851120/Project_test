...
(t = function () {
  ...
  a &&
    ((s = (l.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      l.readyState,
    )),
    ...
    ((function (t) {
      ...
      function i(t, e) {
        return (function (t, e) {
          ...
          return (
            (e = r(a.concat(f(e)), 512 + 8 * e.length)), c(r(i.concat(e), 640))
          );
        })(n(t), n(e));
      }
      function e(t, e, n) {
    ...
    return new Promise(function (o, a) {
      !(function e(t, n) {
        setTimeout(function () {
          var t = i();
          s && console.info(c),
            t ? o(t) : (t = 250 + n) <= r ? e(250, t) : a("timeout");
        }, t);
      })(e, 0);
    });
  }
              ...
              ((n, o, a, i) => {
                parent.FontAwesomeDetection.__pollUntil({
                  fn: () => {
                    ...
                    return !(
                      !n.match(/FontAwesome/) && !n.match(/Font Awesome [56]/)
                    );
                  },
                })
                  .then(() => {
